...
//    private boolean met10;
    ...
    public AWT() {
        Font myFont = new Font("Roboto", Font.ITALIC | Font.BOLD, 12);
                                ...
                                if (met4) {
                                    ...
                                    if (met5) {
                                        ...
                                        if (met6) {
                                            ...
                                            if (met7) {
                                                met8 = firstAttempt.randNumber();
                                                requirements8.setText("Must include this random number " + "(" + firstAttempt.getDisplayNum() + "):" + met8);
                                                if (met8) {
...
//                    requirements10.setText(String.valueOf(met10));
